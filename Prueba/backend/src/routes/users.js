...
router.put('/admin/:id', authenticateToken, requireAdmin, validateId, async (req, res) => {
  try {
    const { id } = req.params;
    const { name, email, role, phone, address, city, state, zip_code } = req.body;
...
router.delete('/admin/:id', authenticateToken, requireAdmin, validateId, async (req, res) => {
  try {
    const { id } = req.params;
